...
### 1. [Frontend] Build a SPA that displays weather information
The complete specification for this exercise can be found in the [EmployeeData.md](EmployeeData.md).
